<template>
    <div class="section" style="margin-top: -4.67vh;">
        <div class="container input-group">
            <input type="text" v-model="search" class="form-control border border-dark p-3" placeholder="搜索你要查看的内容..." style="z-index: 1;width: 100%;height: 86.766px;color: #92a0aa;box-shadow: rgba(0,0,0,.2) 0px 5px 5px 0.5px;">
                ...
                <div class="col" v-for="data in artDatasMark" :key="data._id">
                    <div class="card mb-4 text-dark card-shadow">
                        ...
                        <div class="card-body py-3">
                            ...
                            <a class="card-type float-right mt-1 text-decoration-dark" style="cursor:pointer;" @click="handleToType(data.Type)">
            ...
            <div class="pageObjs mb-4">
                <div class="container">
                    <div class="row row-cols-3">
                        ...
                        <div class="col-2">
                            <button type="button" class="btn-radius btn-radius-alive float-right border-0 page-right" style="width: 64px;height: 64px;background-image: url(/images/fas\ fa-chevron-circle-right.svg);background-position: center;background-repeat: no-repeat;background-clip: content-box;"
