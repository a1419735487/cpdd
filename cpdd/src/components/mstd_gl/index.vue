<template>
    <div class="section" style="margin-top: -4.67vh;">
        <div class="container input-group">
            <input type="text" v-model="search"  class="form-control border border-danger p-3" placeholder="在美食生活中利用回车搜索..." style="z-index: 1;width: 100%;height: 86.766px;color: #92a0aa;box-shadow: rgba(0,0,0,.2) 0px 5px 5px 0.5px;">
            <div class="input-group-append">
                <button class="btn position-relative mr-1 d-xl-block d-none" type="submit" @click="searchTitle" style="margin-top: -6.48vh;margin-left: 979.6px;width: 40px;height: 40px;background-image: url(/images/fas\ fa-search\ red.svg);background-size: 40px 40px; background-color: transparent;background-position: center;background-repeat: no-repeat;"></button>
...
export default {
    ...
    mounted(){
        axios.get("/api/profiles/美食生活").then(res => {
