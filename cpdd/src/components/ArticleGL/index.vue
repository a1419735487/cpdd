<template>
    <div class="section" style="margin-top: -4.67vh;">
        <div class="container input-group">
            <input type="text" v-model="search" id='search' class="form-control border border-danger p-3" placeholder="搜索你要查看的内容..." style="z-index: 1;width: 100%;height: 86.766px;color: #92a0aa;box-shadow: rgba(0,0,0,.2) 0px 5px 5px 0.5px;">
                ...
                <div class="col" v-for="data in artDatasMark" :key="data._id">
                    <div class="card mb-4 text-danger card-shadow">
                        ...
                        <div class="card-body py-3">
                            ...
                            <a class="card-type float-right mt-1 text-decoration-danger" style="cursor:pointer;" @click="handleToType(data.Type)">
